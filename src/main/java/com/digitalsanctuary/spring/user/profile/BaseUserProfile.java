...
/**
 * Abstract base class for user profile entities that extend the core {@link User} functionality.
 * Provides the foundation for creating application-specific user profiles with shared common attributes.
 *
 * <p>
 * This class uses {@code @MappedSuperclass} to allow inheritance of JPA mappings, enabling
 * extending classes to add additional fields while maintaining a consistent database structure.
 * The profile shares its primary key with the associated {@link User} entity through the
 ...
 *
 * <p>
 * Database structure includes: id/user_id (PK/FK to user_account table), last_accessed (timestamp),
 * and preferred_locale (varchar).
 * </p>
 *
 * @see User
