...
public class LogoutSuccessService extends SimpleUrlLogoutSuccessHandler implements LogoutSuccessHandler {
	...
	public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
		...
		logger.debug("LogoutSuccessService.onAuthenticationSuccess:" + "targetUrl: {}",
		...
		AuditEvent logoutAuditEvent = new AuditEvent(this, user, request.getSession().getId(),
				UserUtils.getClientIP(request), request.getHeader("User-Agent"), "Logout", "Success", "Success", null);
